...
const WAVE_COLORS = ['#16A34A','#22C55E','#4ADE80','#86EFAC','#16A34A','#22C55E','#4ADE80','#86EFAC','#16A34A','#22C55E','#4ADE80','#86EFAC','#16A34A','#22C55E','#4ADE80'];
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <section className="relative pt-16 pb-24 lg:pt-24 lg:pb-32 overflow-hidden px-4">
        <div className="absolute top-[-80px] left-1/2 -translate-x-1/2 w-[700px] h-[500px] bg-[#22C55E] rounded-full blur-[140px] opacity-[0.08] -z-10 animate-float-slow pointer-events-none" />
        <div className="absolute top-20 right-[-100px] w-[450px] h-[450px] bg-[#16A34A] rounded-full blur-[120px] opacity-[0.06] -z-10 animate-float pointer-events-none" />
        <div className="absolute bottom-0 left-[-50px] w-[350px] h-[350px] bg-[#4ADE80] rounded-full blur-[120px] opacity-[0.08] -z-10 animate-float-delay pointer-events-none" />
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7">
              ...
              <motion.h1 initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3, delay: 0.1 }} className="text-[clamp(36px,7vw,72px)] font-medium leading-[1] mb-6" style={{ letterSpacing: '-0.035em', color: 'var(--text-ink)' }}>
                ...
                <br />
                <motion.span initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.4 }} className="inline-block text-[#16A34A]">tanda awal TB.</motion.span>
              </motion.h1>
              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.9 }} className="mt-8 flex items-center gap-3 text-sm" style={{ color: 'var(--text-muted)' }}>
                <div className="flex -space-x-2">
                  {['#16A34A','#22C55E','#4ADE80','#86EFAC'].map((c, i) => (
            ...
            <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.9, delay: 0.7, type: 'spring', stiffness: 80 }} className="lg:col-span-5">
              <div className="aspect-square rounded-3xl p-8 flex flex-col items-center justify-center relative overflow-hidden" style={{ backgroundColor: 'var(--bg-soft)' }}>
                ...
                <div className="relative w-24 h-24 md:w-28 md:h-28 mb-8 z-10">
                  <div className="absolute inset-0 rounded-full bg-[#22C55E] opacity-20 animate-pulse-ring" />
                  <div className="absolute inset-0 rounded-full bg-[#22C55E] opacity-10" style={{ animation: 'pulse-ring 1.5s cubic-bezier(0.215, 0.61, 0.355, 1) infinite', animationDelay: '0.5s' }} />
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <RevealOnScroll>
              <h2 className="text-[clamp(28px,4vw,40px)] font-medium mb-6 leading-[1.1]" style={{ color: 'var(--text-ink)', letterSpacing: '-0.025em' }}>
                Mengapa deteksi dini <span className="text-[#16A34A]">sangat penting?</span>
              </h2>
                ...
                {["Batuk kronis sering dianggap sebagai 'batuk biasa' dan diabaikan.", "Deteksi dini meningkatkan tingkat keberhasilan pengobatan secara drastis.", "Satu penderita TB yang tidak diobati dapat menularkan hingga 15 orang dalam setahun."].map((text, i) => (
                  <RevealOnScroll key={i} delay={i * 0.12}>
                    <li className="flex items-start gap-4 group">
                      <div className="mt-0.5 w-6 h-6 rounded-full bg-[#DCFCE7] flex items-center justify-center shrink-0"><CheckCircle2 className="w-3.5 h-3.5 text-[#16A34A]" /></div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <RevealOnScroll delay={0.1}>
                <div className="card-feature bg-[#DCFCE7] text-[#14532D] hover:scale-[1.02] transition-transform duration-300 cursor-default">
              ...
              <RevealOnScroll delay={0.2}>
                <div className="card-feature bg-[#16A34A] text-white hover:scale-[1.02] transition-transform duration-300 cursor-default mt-8">
              ...
              <RevealOnScroll delay={0.25} className="col-span-2">
                <div className="card-feature bg-[#14532D] text-white hover:scale-[1.02] transition-transform duration-300 cursor-default flex items-center gap-5 !py-6">
                  <div className="w-14 h-14 rounded-2xl bg-[#22C55E]/20 flex items-center justify-center shrink-0"><Users className="w-7 h-7 text-[#4ADE80]" /></div>
                  <div>
      ...
      <section id="cara-kerja" className="py-24 relative overflow-hidden" style={{ backgroundColor: 'var(--bg-soft)' }}>
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-6 relative z-10">
            {[
              { icon: Mic, title: 'Rekam Batuk', description: 'Dekatkan smartphone dan rekam suara batuk alami selama 3–6 detik di tempat tenang.', bg: '#F0FDF4' },
              { icon: Activity, title: 'AI Menganalisis', description: 'Gemini AI menganalisis frekuensi & pola akustik batuk Anda secara instan dan akurat.', bg: '#F0FDF4' },
              { icon: Shield, title: 'Dapat Insight', description: 'Terima skor risiko, rekomendasi, dan langkah selanjutnya yang tepat untuk kesehatan Anda.', bg: '#F0FDF4' },
            ].map((step, i) => (
              <RevealOnScroll key={i} delay={i * 0.15}>
                <div className="card-feature flex flex-col items-center text-center hover:scale-[1.02] transition-transform duration-300 cursor-default relative" style={{ backgroundColor: step.bg, border: '1px solid var(--border)' }}>
                  <div className="w-16 h-16 rounded-2xl bg-[#16A34A]/10 flex items-center justify-center mb-6 relative">
                    <step.icon className="w-8 h-8 text-[#16A34A]" />
                    <div className="absolute -top-3 -right-3 w-8 h-8 rounded-full bg-[#16A34A] flex items-center justify-center font-bold text-white text-xs">{i + 1}</div>
                  </div>
                  <h3 className="text-xl font-semibold mb-3" style={{ letterSpacing: '-0.01em', color: '#0a0a0a' }}>{step.title}</h3>
                  <p className="leading-relaxed text-sm" style={{ color: '#0a0a0a', opacity: 0.8 }}>{step.description}</p>
                </div>
              </RevealOnScroll>
            ))}
          </div>
        ...
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          <RevealOnScroll>
            <div className="rounded-3xl p-12 md:p-20 text-center relative overflow-hidden" style={{ backgroundColor: 'var(--bg-soft)' }}>
              <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-[#22C55E] rounded-full blur-[120px] opacity-[0.06] translate-x-1/3 -translate-y-1/3 pointer-events-none" />
              <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-[#16A34A] rounded-full blur-[120px] opacity-[0.06] -translate-x-1/3 translate-y-1/3 pointer-events-none" />
              <div className="relative z-10">
                ...
                <h2 className="text-[clamp(28px,5vw,40px)] font-medium mb-6 leading-[1.1]" style={{ color: 'var(--text-ink)', letterSpacing: '-0.025em' }}>
                  Kesehatan paru-paru Anda <span className="text-[#16A34A]">sangat berharga.</span>
                </h2>
